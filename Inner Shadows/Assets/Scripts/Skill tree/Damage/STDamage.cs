...
public class STDamage : MonoBehaviour
{
    ...
    {
        Color newColor;
        if (ColorUtility.TryParseHtmlString("#FFC800", out newColor))
        {
    ...
    public void Level1()
    {
        if (!F_click && skillTree.skillPoints > 0 && water.spikeDead)
        {
    ...
    public void HoverOnLevel1()
    {
        ...
        // Set the text
        SetSkillInfoText("Damage level 1");
    }
    public void HoverOnLevel2()
    {
        ...
        // Set the text
        SetSkillInfoText("Damage level 2");
    }
    public void HoverOnLevel3()
    {
        ...
        // Set the text
        SetSkillInfoText("Damage level 3");
    }
