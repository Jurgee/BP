...
public class STClimb : MonoBehaviour
{
    ...
    {
        Color newColor;
        if (ColorUtility.TryParseHtmlString("#7139C0", out newColor))
        {
    ...
    public void Level1()
    {
        if (!F_click && skillTree.skillPoints > 0 && movement.canClimb)
        {
            movement.climbSpeed = 5f;
    ...
    public void HoverOnLevel1()
    {
        ...
        // Set the text
        SetSkillInfoText("Climb speed level 1");
    }
    public void HoverOnLevel2()
    {
        ...
        // Set the text
        SetSkillInfoText("Climb speed level 2");
    }
    public void HoverOnLevel3()
    {
        ...
        // Set the text
        SetSkillInfoText("Climb speed level 3");
    }
